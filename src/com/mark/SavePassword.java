...
public class SavePassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Do you want to generate a random password? (yes/no)?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        username = siteName.getText();
        sitename = userName.getText();
        
        PasswordManager.savePassword(sitename, username, password);
        //new generatedpassword(password).setVisible(true);
